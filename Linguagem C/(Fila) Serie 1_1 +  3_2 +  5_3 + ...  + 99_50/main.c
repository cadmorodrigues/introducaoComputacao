/* Programa para criar os 50 termos da serie :
   1/1   3/2   5/3   ...99/50 armazenando-os em uma fila.
   Calcular e imprimir a soma dos termos da fila.
*/
#include <stdio.h>
#include <stdlib.h>
/* definicao de tipo */
...
int main()
{
    ...
    {
       fila_insere(f,numerador,denominador);
